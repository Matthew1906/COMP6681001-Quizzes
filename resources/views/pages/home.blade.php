...
@section('body')
    <div class="container">
        <div class="row bg-white rounded-3 p-4">
            <div
                class="col-12 col-lg-5 mb-4 mb-lg-0 d-flex flex-column justify-content-center align-items-center border shadow-sm rounded-4 py-3 px-5 py-lg-5">
            ...
            <div class="col-12 col-lg-7">
                <div class="row px-3">
                    <div class="col p-3 p-lg-5 rounded-2"
                            ...
                            @foreach ($quizzes as $quiz)
                                @php
                                    $scores = $quiz->histories
                                        ...
                                        ->whereNotNull();
                                @endphp
                                <li class='text-primary text-white text-left font-weight-bold fs-3'>
